    ...
    public void setCamera(Camera camera) {
        ...
        if (camera != null) {
            ...
            for (Size s : supportedPreviewSizes) {
                Log.d(YoutubeMainActivity.APP_NAME, String.format("Supported size: %dw x %dh", s.width, s.height));
            }
            requestLayout();
        }
    }
...
/*        final int width = StreamerActivity.CAMERA_WIDTH; // = resolveSize(getSuggestedMinimumWidth(), StreamerActivity.CAMERA_WIDTH);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            Log.e(YoutubeMainActivity.APP_NAME, "IOException caused by setPreviewDisplay()", exception);
        }
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        if (camera != null) {
            try {
                ...
                Log.e(YoutubeMainActivity.APP_NAME, "Caught IOException", e);
            }
        }
    }
