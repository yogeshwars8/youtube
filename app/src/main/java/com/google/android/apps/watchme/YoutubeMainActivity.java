 ...
 */
public class YoutubeMainActivity extends Activity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.youtube_activity_main_menu, menu);
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, YoutubeMainActivity.this,
    ...
    private class GetLiveEventsTask extends
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(YoutubeMainActivity.this, null,
        ...
        protected List<EventData> doInBackground(
            ...
            try {
                ...
                Log.e(YoutubeMainActivity.APP_NAME, "", e);
            }
            return null;
        }
    ...
    private class CreateLiveEventTask extends
        ...
        protected void onPostExecute(
            ...
            startStreaming(fetchedEvents.get(0));
            for (int i = 0; i < fetchedEvents.size(); i++) {
                System.out.println("EVENTS: " + fetchedEvents.get(i).getTitle()+" \n");
            }
