...
public class AudioFrameGrabber {
    ...
    public void start(int frequency) {
        Log.d(YoutubeMainActivity.APP_NAME, "start");
    ...
    public void recordThread() {
        Log.d(YoutubeMainActivity.APP_NAME, "recordThread");

        int audioEncoding = AudioFormat.ENCODING_PCM_16BIT;
        int channelConfiguration = AudioFormat.CHANNEL_CONFIGURATION_STEREO;
        int bufferSize = AudioRecord.getMinBufferSize(frequency, channelConfiguration, audioEncoding);
        Log.i(YoutubeMainActivity.APP_NAME, "AudioRecord buffer size: " + bufferSize);
        ...
        while (!cancel) {
            ...
            if (bufferReadResult > 0) {
                ...
                Log.w(YoutubeMainActivity.APP_NAME, "Error calling recorder.read: " + bufferReadResult);
            }
        }
        recorder.stop();

        Log.d(YoutubeMainActivity.APP_NAME, "exit recordThread");
    }
     ...
     */
    public void stop() {
        Log.d(YoutubeMainActivity.APP_NAME, "stop");
