...
public class StreamerService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        Log.d(YoutubeMainActivity.APP_NAME, "onBind");
        return binder;
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Log.d(YoutubeMainActivity.APP_NAME, "onUnbind");
    ...
    public void releaseCamera() {
        Log.d(YoutubeMainActivity.APP_NAME, "releaseCamera");
        if (!isStreaming() && camera != null) {
            Utils.releaseCamera();
            Log.d(YoutubeMainActivity.APP_NAME, "Camera was released.");
            camera = null;
        } else {
            Log.d(YoutubeMainActivity.APP_NAME, "Camera was not released.");
        }
    }
    ...
    private void showForegroundNotification() {
        ...
        Intent notificationIntent = new Intent(this, YoutubeMainActivity.class);
