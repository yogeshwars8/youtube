...
public class StreamerActivity extends Activity {
    ...
    private ServiceConnection streamerConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.d(YoutubeMainActivity.APP_NAME, "onServiceConnected");
        ...
        public void onServiceDisconnected(ComponentName className) {
            Log.e(YoutubeMainActivity.APP_NAME, "onServiceDisconnected");
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d(YoutubeMainActivity.APP_NAME, "onCreate");
        super.onCreate(savedInstanceState);

        broadcastId = getIntent().getStringExtra(YouTubeApi.BROADCAST_ID_KEY);
        System.out.println("BROADCAST ID:" + broadcastId);

        //Log.v(YoutubeMainActivity.APP_NAME, broadcastId);

        rtmpUrl = getIntent().getStringExtra(YouTubeApi.RTMP_URL_KEY);

        if (rtmpUrl == null) {
            Log.w(YoutubeMainActivity.APP_NAME, "No RTMP URL was passed in; bailing.");
            finish();
        }
        Log.i(YoutubeMainActivity.APP_NAME, String.format("Got RTMP URL '%s' from calling activity.", rtmpUrl));
        ...
        if (!bindService(new Intent(this, StreamerService.class), streamerConnection,
            ...
            Log.e(YoutubeMainActivity.APP_NAME, "Failed to bind StreamerService!");
        }
    ...
    protected void onResume() {
        Log.d(YoutubeMainActivity.APP_NAME, "onResume");
    ...
    protected void onPause() {
        Log.d(YoutubeMainActivity.APP_NAME, "onPause");
    ...
    protected void onDestroy() {
        Log.d(YoutubeMainActivity.APP_NAME, "onDestroy");
    ...
    private void startStreaming() {
        Log.d(YoutubeMainActivity.APP_NAME, "startStreaming");
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case REQUEST_CAMERA_MICROPHONE: {
                Log.i(YoutubeMainActivity.APP_NAME, "Received response for camera with mic permissions request.");
                ...
                if (Utils.verifyPermissions(grantResults)) {
                    ...
                    Log.i(YoutubeMainActivity.APP_NAME, "Camera with mic permissions were NOT granted.");
    ...
    private void stopStreaming() {
        Log.d(YoutubeMainActivity.APP_NAME, "stopStreaming");
    ...
    public void onBackPressed() {
         ((Button) findViewById(R.id.endEvent)).performClick();
        super.onBackPressed();
    }
}
